"""
Models for Robot Pose Estimation

Stage 1: BBoxModel - predicts bounding box
Stage 2: KeypointModel - predicts 2D keypoints
Pipeline: TwoStagePipeline - chains both stages
"""
